...
ALTER TABLE "deal_offers" ADD CONSTRAINT "deal_offers_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id"), ADD CONSTRAINT "deal_offers_dealId_fkey" FOREIGN KEY ("dealId") REFERENCES "deals"("id") ON DELETE CASCADE, ADD CONSTRAINT "deal_offers_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id");
ALTER TABLE "requirement_broadcasts" ADD CONSTRAINT "requirement_broadcasts_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id"), ADD CONSTRAINT "requirement_broadcasts_leadId_fkey" FOREIGN KEY ("leadId") REFERENCES "leads"("id") ON DELETE CASCADE, ADD CONSTRAINT "requirement_broadcasts_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id");
ALTER TABLE "requirement_broadcast_recipients" ADD CONSTRAINT "requirement_broadcast_recipients_requirementBroadcastId_fkey" FOREIGN KEY ("requirementBroadcastId") REFERENCES "requirement_broadcasts"("id") ON DELETE CASCADE, ADD CONSTRAINT "requirement_broadcast_recipients_inventoryPartnerId_fkey" FOREIGN KEY ("inventoryPartnerId") REFERENCES "inventory_partners"("id");
ALTER TABLE "match_recommendations" ADD CONSTRAINT "match_recommendations_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id"), ADD CONSTRAINT "match_recommendations_leadId_fkey" FOREIGN KEY ("leadId") REFERENCES "leads"("id") ON DELETE CASCADE, ADD CONSTRAINT "match_recommendations_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "properties"("id") ON DELETE CASCADE, ADD CONSTRAINT "match_recommendations_handledById_fkey" FOREIGN KEY ("handledById") REFERENCES "users"("id");
