...
-- Uniquify any accidental duplicate storageKey values before unique index
...
-- Partial unique: at most one ACTIVE cover image per property
...
-- CreateTable storage_upload_sessions
