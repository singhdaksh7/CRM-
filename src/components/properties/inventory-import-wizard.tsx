...
type PreviewRow = { rowNumber: number; data: Record<string, unknown>; issues: Array<{ field: string; originalValue?: string; message: string; severity: string }>; duplicateClass: string; duplicateReasons: string[]; action: ImportActionValue; state: string; matchedProperty: { id: string; propertyCode: string; title: string } | null; diff: Array<{ field: string; before: unknown; after: unknown }>; partnerResolution: string; sourceResolution: string; localityResolution: string };
