...
export function DocumentVaultClient({ role }: { role: Role }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-3 border-b border-[#E4E4E7] pb-4 sm:flex-row sm:items-start">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#09090B]">Documents</h1>
          <p className="mt-1 text-sm text-[#52525B]">Securely manage property, owner, lead, deal, and payment files</p>
        </div>
